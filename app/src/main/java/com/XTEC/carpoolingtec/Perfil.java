...
public class Perfil extends Fragment {
    ...
    private EditText Name, Mail, Cedula, Id, Pass, PassConf, Phone;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((MainActivity)getContext()).navigationView.setCheckedItem(R.id.Profile);
        ...
        Mail =(EditText) view.findViewById(R.id.txtMail);
        ...
        PassConf = (EditText) view.findViewById(R.id.txtPassConf);
        Phone = (EditText) view.findViewById(R.id.txtPhone);

        //Seteo de los inhabilitados
